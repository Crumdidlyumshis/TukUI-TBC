...
oUF:Factory(function(self)
	...
	local raid = self:SpawnHeader("oUF_TukuiHealRaid0115", nil, "custom [target=raid16,exists] hide;show", "showParty", true, "showPlayer", TukuiCF["unitframes"].showplayerinparty, "showRaid", true, "yOffset", TukuiDB.Scale(-4))
