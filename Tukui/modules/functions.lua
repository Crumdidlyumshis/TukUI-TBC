...
function TukuiDB.PP(p, obj)
	...
	elseif p == 7 then
		obj:SetHeight(TukuiInfoMiddle:GetHeight())
		obj:SetPoint("LEFT", TukuiInfoMiddle, 30, 0.5)
	elseif p == 8 then
		obj:SetHeight(TukuiInfoMiddle:GetHeight())
		obj:SetPoint("CENTER", TukuiInfoMiddle, 0, 0.5)
	elseif p == 9 then
		obj:SetHeight(TukuiInfoMiddle:GetHeight())
		obj:SetPoint("RIGHT", TukuiInfoMiddle, -30, 0.5)
	end
end
...
-- 				self.first = false
-- 			end
-- 			--ChatFrame1:AddMessage(tostring(self.timeLeft))			
...
function TukuiDB.PostCreateAura(element, button)
	-- ChatFrame1:AddMessage('PostCreateAura: ')
	-- for k,v in pairs(button) do
	-- 	ChatFrame1:AddMessage('PostCreateAura iteration: ' ..tostring(k) .. ', ' .. tostring(v))
	-- end
	...
	button.cd:SetReverse() -- om den går fra mørk til lys eller om vendt
...
function TukuiDB.PostCreateEnchantIcon(element, button)
	-- ChatFrame1:AddMessage('PostCreateEnchantIcon: ' .. button:GetName() .. ', ' .. tostring(element:GetName()))
	-- for k,v in pairs(button) do
	-- 	ChatFrame1:AddMessage('PostCreateEnchantIcon: ' ..tostring(k) .. ', ' .. tostring(v))
	-- end
	TukuiDB.SetTemplate(button)
	...
	button.overlay:Hide() -- hide the ugly white border...
...
function TukuiDB.PostUpdateEnchantIcons(icons)
	--ChatFrame1:AddMessage('PostUpdateEnchantIcons: ' ..tostring(icons))		
	local icon1 = icons[1];
	if icon1 then
...
-- 	local threatAmount = Threat:GetThreat()
-- 	if threatAmount == 
-- end
