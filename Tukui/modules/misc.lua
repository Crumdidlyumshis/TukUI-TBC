...
OptionsFrameSlider1:Hide();
OptionsFrameCheckButton9:Hide()

-- tutorial button shit
--TukuiDB.Kill(TutorialFrameAlertButton) -- I don't care about that for now.
TukuiDB.Kill(ReadyCheckPortrait)
...
-- ReadyCheck
SlashCmdList.READY_CHECK = function() DoReadyCheck() end
