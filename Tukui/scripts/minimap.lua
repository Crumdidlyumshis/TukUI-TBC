...
local mmparent = CreateFrame("Frame", "MinimapParent", UIParent)
TukuiDB.CreatePanel(mmparent, 370, 23, "BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", TukuiDB.Scale(-10), TukuiDB.Scale(10))
mmparent:SetFrameStrata("BACKGROUND")
mmparent:SetAlpha(0)

Minimap:ClearAllPoints()
Minimap:SetPoint("BOTTOMRIGHT", mmparent, "TOPRIGHT", TukuiDB.Scale(-2), TukuiDB.Scale(5))
--Minimap:SetSize(TukuiDB.Scale(143), TukuiDB.Scale(135))
Minimap:SetHeight(TukuiDB.Scale(135))
Minimap:SetWidth(TukuiDB.Scale(143))
...
-- Hide Minimap Toggle button
MinimapToggleButton:Hide()

-- shitty 3.3 flag to move -- 2.4.3 biatch
-- MiniMapInstanceDifficulty:ClearAllPoints()
-- MiniMapInstanceDifficulty:SetParent(Minimap)
-- MiniMapInstanceDifficulty:SetPoint("BOTTOMLEFT", Minimap, "BOTTOMLEFT", 0, 0)

-- local function UpdateLFG()
-- 	MiniMapLFGFrame:ClearAllPoints()
-- 	MiniMapLFGFrame:SetPoint("TOPLEFT", Minimap, "TOPLEFT", 0, 0)
...
-- reskin LFG dropdown
--TukuiDB.SetTemplate(LFDSearchStatus) -- findes ikke i 2.4.3
...
-- set_anim(m_zone,true,TukuiDB.Scale(320),0)
m_zone:Hide()
