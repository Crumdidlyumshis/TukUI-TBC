...
local glowTexture = [[Interface\AddOns\Tukui\media\textures\glowTex]]
...
local updatePlate = function(self)
	...
	self.level:SetPoint("BOTTOMRIGHT", self.healthBar, "TOPRIGHT", TukuiDB.Scale(-2), 3)
...
local createPlate = function(frame)
	...
	newNameRegion:SetPoint("BOTTOMLEFT", healthBar, "TOPLEFT", 0, TukuiDB.Scale(3))
