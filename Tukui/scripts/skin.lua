...
local function SetModifiedBackdrop(self)
	self:SetBackdropColor(0, .8, 1, 0.075)
...
TukuiSkin:SetScript("OnEvent", function(self, event, addon)
	...
	if addon == "Tukui" then
		...
		-- Dropping reposition for now, because TBC has an entirely different layout compared to CATA and up.
		...
		-- readycheck artwork
		select(2,ReadyCheckFrame:GetRegions()):Hide()
		-- others
