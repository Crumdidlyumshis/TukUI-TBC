...
local GetCoinTextureString = function ( ... )
	return ("%dg %ds %dc"):format(GetMoney() / 100 / 100, (GetMoney() / 100) % 100, GetMoney() % 100);
end
...
function Stuffing:SlotNew (bag, slot)
	...
	--print('hmmm ' .. tostring(ret.frame:GetName()) .. ' - hmm more' .. tostring(_G[ret.frame:GetName()]:GetName()) .. ' - ' .. bag .. ', ' .. slot .. ' - ')
