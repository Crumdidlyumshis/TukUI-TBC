...
local function style(self)  
	...
	if not _G[name.."Panel"] then
		this:SetWidth(TukuiDB.buttonsize)
		this:SetHeight(TukuiDB.buttonsize)
		
		local panel = CreateFrame("Frame", name.."Panel", this)
		TukuiDB.CreatePanel(panel, TukuiDB.buttonsize, TukuiDB.buttonsize, "CENTER", this, "CENTER", 0, 0)
		panel:SetBackdropColor(0, 0, 0, 0)
		panel:SetFrameStrata(this:GetFrameStrata())
		panel:SetFrameLevel(this:GetFrameLevel() - 1)
